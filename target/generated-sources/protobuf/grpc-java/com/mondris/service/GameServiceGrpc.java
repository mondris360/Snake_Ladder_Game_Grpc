...
public final class GameServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.mondris.service.Die,
      com.mondris.service.GameState> getRollDieMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "rollDie",
      requestType = com.mondris.service.Die.class,
      responseType = com.mondris.service.GameState.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.mondris.service.Die,
      com.mondris.service.GameState> getRollDieMethod() {
    io.grpc.MethodDescriptor<com.mondris.service.Die, com.mondris.service.GameState> getRollDieMethod;
    if ((getRollDieMethod = GameServiceGrpc.getRollDieMethod) == null) {
      synchronized (GameServiceGrpc.class) {
        if ((getRollDieMethod = GameServiceGrpc.getRollDieMethod) == null) {
          GameServiceGrpc.getRollDieMethod = getRollDieMethod = 
              io.grpc.MethodDescriptor.<com.mondris.service.Die, com.mondris.service.GameState>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "GameService", "rollDie"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mondris.service.Die.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mondris.service.GameState.getDefaultInstance()))
                  .setSchemaDescriptor(new GameServiceMethodDescriptorSupplier("rollDie"))
                  .build();
          }
        }
     }
     return getRollDieMethod;
  }
  ...
  public static abstract class GameServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.mondris.service.Die> rollDie(
        io.grpc.stub.StreamObserver<com.mondris.service.GameState> responseObserver) {
      return asyncUnimplementedStreamingCall(getRollDieMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.mondris.service.Die,
                com.mondris.service.GameState>(
                  this, METHODID_ROLL_DIE)))
          .build();
    }
  }
  ...
  public static final class GameServiceStub extends io.grpc.stub.AbstractStub<GameServiceStub> {
    ...
    public io.grpc.stub.StreamObserver<com.mondris.service.Die> rollDie(
      ...
      return asyncBidiStreamingCall(
          getChannel().newCall(getRollDieMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  private static final int METHODID_ROLL_DIE = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_ROLL_DIE:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.rollDie(
              (io.grpc.stub.StreamObserver<com.mondris.service.GameState>) responseObserver);
        default:
          throw new AssertionError();
      }
  ...
  private static abstract class GameServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.mondris.service.BankService.getDescriptor();
    }
